...
import GreetingMessagesEditor from "./GreetingMessagesEditor";
...
export default function FlowFormModal({ flow, onClose, onSave }) {
  const [form, setForm] = useState({
    ...
    steps: flow?.steps || 1,
    greeting_messages: flow?.greeting_messages || [],
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-card rounded-xl border border-border w-full max-w-xl max-h-[90vh] overflow-y-auto scrollbar-thin p-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-2 border-t border-border">
            <GreetingMessagesEditor
              messages={form.greeting_messages}
              onChange={(greeting_messages) => setForm({ ...form, greeting_messages })}
            />
          </div>
          ...
          <div className="pt-2 border-t border-border">
            <MenuOptionsEditor
              ...
              onChange={(menu_options) => setForm({ ...form, menu_options })}
            />
          </div>
